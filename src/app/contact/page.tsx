      ...
      <div className="px-2 lg:mx-auto container">
        ...
        <div className="grid lg:grid-cols-2 pt-12 lg:h-[480px] mb-12 lg:mb-24">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="flex items-center gap-x-4 text-lg text-primary mb-4">
              <span className="w-[30px] h-[2px] bg-primary"></span>
              Say Hello
            </h1>
            <h1 className="h1 font-bold max-w-md mb-8">
              Let&apos;s Work Together.
            </h1>
            <p className="max-w-[400px] subtitle">
              Did You Like it? Any Ways I am a Mern Stack Developer with almost
              1.5 year of experience and expertise in building responsive and
              dynamic websites with Modern UIs.
            </p>
          </div>
          {/* Img */}
