...
const HeroSection = () => {
  return (
    <section className="mt-10 mx-2 flex justify-center">
      <div className="flex justify-center items-center relative 2xl:w-[1216px] 2xl:h-[650px] lg:w-[1000px] lg:h-[500px]">
        <Image
          src="/hero-section/hero-img.png"
          alt="hero-img"
          width={1000}
          height={500}
          className="2xl:w-[1216px] 2xl:h-[650px] lg:w-[1000px] lg:h-[500px] dark:brightness-150"
        />
