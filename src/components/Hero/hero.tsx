      ...
      <div className="flex justify-center items-center relative 2xl:w-[1300px] 2xl:h-[650px] lg:w-[1200px] lg:h-[500px]">
        <div>
          <Image
            ...
            width={1216}
            height={650}
            className="2xl:w-[1300px] fade-in 2xl:h-[650px] lg:w-[1200px] lg:h-[500px] dark:brightness-150"
          />
        </div>
        <div className="fade-in absolute lg:-bottom-10 lg:left-20 -bottom-12 left-5 flex items-center flex-col">
          <div className="w-[500px] h-[260px] hidden lg:block bg-white dark:bg-background shadow-bottom rounded-lg ring-1 ring-slate-50 ring-opacity-10 lg:px-8 lg:py-8">
            <Button className="text-xs h-8 px-3">Technology</Button>
